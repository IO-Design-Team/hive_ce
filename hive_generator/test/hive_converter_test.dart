...
''',
    ...
    test('applies converter from field annotation', () {
      expectGeneration(
        input: {
          ...pubspec(),
          'lib/hive/hive_adapters.dart': '''
...
@GenerateAdapters([AdapterSpec<Event>()])
class Event {
  const Event(this.time);
...
''',
    ...
    test('applies converter from class annotation', () {
      expectGeneration(
        input: {
          ...pubspec(),
          'lib/hive/hive_adapters.dart': '''
...
''',
    ...
    test('applies converter from AdapterSpec.converters', () {
      expectGeneration(
        input: {
          ...pubspec(),
          'lib/hive/hive_adapters.dart': '''
...
@GenerateAdapters([
  AdapterSpec<Event>(converters: [EpochDateTimeConverter()]),
])
class Event {
  const Event(this.time);
